...
VALUES (@job_id, @stashdb_scene_id, @title, sqlc.narg('studio_name'), sqlc.narg('studio_slug'), sqlc.narg('release_date'), sqlc.narg('duration_seconds'), @performers, @tags, sqlc.narg('raw_response'), sqlc.narg('image_url'))
RETURNING *;
