...
type Querier interface {
	...
	CreateJobWithStatus(ctx context.Context, arg CreateJobWithStatusParams) (Job, error)
	CreateLocalDownload(ctx context.Context, arg CreateLocalDownloadParams) (Download, error)
	...
	DeleteBatchJob(ctx context.Context, id uuid.UUID) error
	...
	GetLocalFoundDownloads(ctx context.Context) ([]GetLocalFoundDownloadsRow, error)
	...
	GetSearchFailedScenes(ctx context.Context) ([]Scene, error)
	GetSearchResultByID(ctx context.Context, id uuid.UUID) (SearchResult, error)
